...
# ===== إعدادات البوت =====
TOKEN = os.getenv("7710008981:AAEJFnrDt0ErhcbqL6WzMWdUShde9m2-0o0")  # تأكد أنك ضبطت متغير البيئة TOKEN
...
async def get_api_token(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not stream_url:
        await update.message.reply_text("❌ لم يتم العثور على stream_url.")
        return ConversationHandler.END
...
def main():
    ...
    # Conversation for classic stream setup
    ...
    # Conversation for API stream setup
