...
# عند الضغط على تجهيز البث نعرض خيارات البث (Live FB أو Live IG)
...
# المستخدم يختار نوع البث (FB أو IG)
async def select_broadcast_type(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
    context.user_data["broadcast_type"] = query.data  # "live_fb" أو "live_ig"
...
async def get_stream_key(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if broadcast_type == "live_fb":
        ...
        # مفتاح للبث على انستاجرام (عادة يكون جزء من الرابط كامل)
        # في العادة الانستاجرام يأخذ رابط واحد كامل، ندمج الرابط و المفتاح ببعض
        # حسب المعطيات التي ذكرتها، لنفترض المفتاح هو الجزء بعد base url.
        # مثال:
        # rtmps://edgetee-upload-lis1-1.xx.fbcdn.net:443/rtmp/
        # مفتاح : 18049201910383861?s_bl=1&s_fbp=...
        # ندمجهم:
        output = f"rtmps://edgetee-upload-lis1-1.xx.fbcdn.net:443/rtmp/{key}"
    else:
